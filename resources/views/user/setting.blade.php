                                        ...
                                        <li>
                                            <div class="edit-seting" title="Edit Profile image"><i
                                                ...
                                                <ul class="more-dropdown">
                                                    ...
                                                    <li><a href="{{ url('setting') }}" title="">Update Header Photo</a>
                                                    </li>
                                                    <li><a href="{{ url('setting') }}" title="">Account Settings</a>
                                                    </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-md-3">
                                            <div class="profile-author">
                                                ...
                                                <div class="author-content">
                                                    <a class="h4 author-name" href="{{ url('about') }}">Jack Carter</a>
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <ul class="profile-menu">
                                                <li>
                                                    <a class="active" href="{{ url('timeline') }}">Timeline</a>
                                                </li>
                                                <li>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="gen-setting">
                                                    <div class="set-title">
                                                        ...
                                                        <span>Set your login preference, help us personalize your
                                                            experience and make big account change here.</span>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade" id="edit-profile">
                                                    ...
                                                    <div class="setting-meta">
                                                        <div class="change-photo">
                                                            <figure><img src="images/resources/admin2.jpg" alt="">
                                                            </figure>
                                                            <div class="edit-img">
                                                    ...
                                                    <div class="stg-form-area">
                                                        <form method="post" class="c-form">
                                                            ...
                                                            <div class="uzer-nam">
                                                                ...
                                                                <span>www.pitnik.com/</span><input type="text"
                                                    ...
                                                    <div class="notifi-seting">
                                                        <div class="form-radio">
                                                            <div class="radio">
                                                                <label>
                                                                    <input type="radio" checked="checked"
                                                                        name="radio"><i class="check-box"></i>
                                                                    Send Me emails about my activity except emails i
                                                                    have unsubscribe from
                                                                </label>
                                                            </div>
                                                            <div class="radio">
                                                                <label>
                                                ...
                                                <div class="tab-pane fade" id="messages" role="tabpanel">
                                                    <div class="set-title">
                                                        ...
                                                        <div class="mesg-seting">
                                                            ...
                                                            <div class="set-title">
                                                                <h6>i'd like to receive emails and updates from Pitnik
                                                                    about</h6>
                                                            </div>
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" checked="checked"><i
                                                                        class="check-box"></i>
                                                                    Always General announcement, updates, posts, and
                                                                    videos.
                                                                </label>
                                                                <label>
                                                                    <input type="checkbox" checked="checked"><i
                                                            ...
                                                            <p>
                                                                you will always get notifications you have turned on for
                                                                individual <a href="#" title="">Manage All
                                                                    Subscriptions</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade" id="weather" role="tabpanel">
                                                    <div class="set-title">
                                                        ...
                                                        <div class="mesg-seting">
                                                            ...
                                                            <p>
                                                                you will always get Daily notifications you have turned
                                                                on for individual.
                                                            </p>
                                                            <div>
                                                                <form>
                                                ...
                                                <div class="tab-pane fade" id="page-manage" role="tabpanel">
                                                    <div class="set-title">
                                                        <h5>Page & sidebar</h5>
                                                        <span>Deceide whether your profile will be hidden from search
                                                            engine and what kind of data you want to use to imporve the
                                                            recommendation and ads you see <a href="#" title="">Learn
                                                                more</a></span>
                                                    </div>
                                                    <p class="p-info"><a href="manage-page.html">Click here</a> to go
                                                        widget and page setting area</p>
                                                </div><!-- privacy -->
                                                <div class="tab-pane fade" id="privacy" role="tabpanel">
                                                    ...
                                                    <div class="onoff-options ">
                                                        <form method="post">
                                                            ...
                                                            <div class="setting-row">
                                                                <span>Search Privacy</span>
                                                                <p>use sites you visit to improve which recommendation
                                                                    and ads you see. <a href="#" title="">Learn more</a>
                                                                </p>
                                                            ...
                                                            <div class="setting-row">
                                                                <span>Search Privacy</span>
                                                                <p>use information from our partners to improve which
                                                ...
                                                <div class="tab-pane fade" id="apps" role="tabpanel">
                                                    <div class="set-title">
                                                        ...
                                                        <span>Keep track of everywhere you have login with your pintik
                                                            profile and remove access from apps you are no longer using
                                                            with pitnik <a href="#" title="">Learn more</a></span>
                                                    </div>
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="your-page">
                                            ...
                                            <div class="page-meta">
                                                ...
                                                <span><i class="ti-comment"></i>Messages <em
                                                        class="bg-blue">9</em></span>

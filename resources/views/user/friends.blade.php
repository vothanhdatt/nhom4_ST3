                        ...
                        <div class="row merged20" id="page-contents">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <ul class="profile-menu">
                                                ...
                                                <li>
                                                    <a class="active"
                                                        href="{{asset('friends')}}/{{$user->id}}">Friends</a>
                                                </li>
                                                <li>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="central-meta padding30">
                                    <div class="row">
                                        @foreach($friend as $listfriend)
                                        @foreach($alluser as $userfr)
                                        @if($userfr->id == $listfriend->id_accept)
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="friend-box">
                                                <figure>
                                                    <img src="{{asset('images/resources')}}/frnd-cover1.jpg" alt="">
                                                    <span>Followers: 120</span>
                                                </figure>
                                                <div class="frnd-meta">
                                                    <img src="{{asset('images/resources')}}/{{$userfr->profile->avatar}}" alt="">
                                                    <div class="frnd-name">
                                                        <a href="{{asset('timeline')}}/{{$userfr->id}}" title="">{{$userfr->name}}</a>
                                                        <span>{{$userfr->profile->address}}</span>
                                                    </div>
                                                    <ul class="frnd-info">
                                                        
                                                        
                                                        <li><span>Photos:</span> {{count($slimages)}}</li>
                                                        <li><span>Post:</span> {{count($userfr->post)}}</li>
                                                        <li><span>Address:</span> {{$userfr->profile->address}}</li>
                                                    ...
                                                    <div class="more-opotnz">
                                                        ...
                                                        <ul>
                                                            <li><a href="{{asset('timeline')}}/{{$userfr->id}}" title="">Timeline</a></li>
                                                            <li><a href="{{asset('about')}}/{{$userfr->id}}" title="">About</a></li>
                                                            <li><a href="{{asset('photos')}}/{{$userfr->id}}" title="">Photos</a></li>
                                                            <li><a href="{{asset('friends')}}/{{$userfr->id}}" title="">Friends</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        @foreach($friend1 as $listfriend)
                                        @foreach($alluser as $userfr)
                                        @if($userfr->id == $listfriend->id_request)
                                        <!-- {{var_dump($userfr)}} -->
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="friend-box">
                                                <figure>

											...
											<div class="user-post">
												<div class="friend-info">
													...
													<div class="friend-name">
														...
														<ins><a href="time-line.html" title=""><?php echo($value1['id_user']) ?></a> Post
															Album</ins>
														<span><i class="fa fa-globe"></i> <?php echo($value1['created_post']) ?> </span>
													</div>
													<div class="post-meta">
														<p>
															<?php 
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6">
																		<figure>
																			<a href="#" title="" data-toggle="modal"
																				...
																				<img src="images/resources/<?php echo($value1['image']) ?>"
																					alt="">
																			</a>
																		</figure>
															...
															<ul>
																...
																<li>
																	<div class="likes heart" title="Like/Dislike">❤
																		<span><?php echo($value1['like']) ?></span></div>
																</li>
																<li>

        ...
        <div class="topbar stick">
            ...
            <div class="top-area">
                ...
                <div class="user-img">
                    ...
                    <img src="images/resources/<?php echo(Auth::user()->avatar) ?>" alt=""  height="36px" width="36px">
                    <span class="status f-online"></span>
                    <div class="user-setting">
                        ...
                        <ul class="log-out">
                            <li><a href="{{ url('timeline') }}" title=""><i class="ti-user"></i> view profile</a></li>
                            <li><a href="{{ url('setting') }}" title=""><i class="ti-pencil-alt"></i>edit profile</a>
                            </li>
                            <li><a href="#" title=""><i class="ti-target"></i>activity log</a></li>
                            <li><a href="{{ url('setting') }}" title=""><i class="ti-settings"></i>account setting</a>
                            </li>
        ...
        <div class="fixed-sidebar left">
            <div class="menu-left">
                <ul class="left-menu">
                    ...
                    <li>
                        <a href="{{ url('newsfeed') }}" title="Newsfeed Page" data-toggle="tooltip"
                    ...
                    <li>
                        <a href="{{ url('friends') }}" title="Friends" data-toggle="tooltip" data-placement="right">
                            <i class="ti-user"></i>
                        </a>
                    </li>
                    <li>
